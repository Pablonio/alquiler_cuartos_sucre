      ...
      <div className="bg-white rounded-lg shadow p-6">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="mb-4">
              <label className="block text-sm font-semibold mb-1" htmlFor="direccion">Dirección</label>
              <input
                type="text"
                id="direccion"
                name="direccion"
            ...
            <div className="mb-4">
              <label className="block text-sm font-semibold mb-1" htmlFor="cantidadHabitaciones">Cantidad de Habitaciones</label>
              <input
                type="number"
